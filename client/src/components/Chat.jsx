  ...
  useEffect(() => {
    if (index < content.length) {
      const timeout = setTimeout(() => {
        ...
        // Call the scroll function every time a new character is added
        if (onType) onType();
      }, speed);
...
const Chat = () => {
  ...
  // Fix: Define isLastMessage by comparing current index to total messages
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          {/* Use typewriter ONLY for the newest bot message */}
