      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12 sm:mb-16 lg:mb-20">
          <h2 className="text-2xl sm:text-3xl lg:text-4xl xl:text-5xl font-semibold mb-4 sm:mb-6">
            <span className="text-black">How to use StudyLM?</span>
          </h2>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
          <div className="glassmorphism rounded-2xl p-6 sm:p-8 card-hover">
            ...
            <h3 className="text-lg sm:text-xl text-black font-semibold mb-3 sm:mb-4">Easy Upload</h3>
            <p className="text-black/30 text-sm sm:text-base leading-relaxed">
          ...
          <div className="glassmorphism rounded-2xl p-6 sm:p-8 card-hover">
            ...
            <h3 className="text-lg sm:text-xl text-black font-semibold mb-3 sm:mb-4">AI Chat Interface</h3>
            <p className="text-black/30 text-sm sm:text-base leading-relaxed">
          ...
          <div className="glassmorphism rounded-2xl p-6 sm:p-8 card-hover sm:col-span-2 lg:col-span-1">
            ...
            <h3 className="text-lg sm:text-xl text-black font-semibold mb-3 sm:mb-4">Instant Analysis</h3>
            <p className="text-black/30 text-sm sm:text-base leading-relaxed">
