...
const Welcome = () => {
  ...
  return (
    <div className="relative flex flex-col items-center justify-center h-full max-w-5xl mx-auto">
      {/* Welcome message */}
      ...
      Upload documents, get instant answers, and master your knowledge effortlessly.
      </p>
      <Link
          to="/conversation"
