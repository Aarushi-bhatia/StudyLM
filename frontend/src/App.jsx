        ...
        {!isDocumentUploaded && (
          ...
          <div className="space-y-6 pb-4">
            ...
            {answers.map((item, index) => (
              <div key={index} className={`max-w-3xl mx-auto ${item.type === 'question' ? 'ml-auto mr-0 max-w-xl' : ''}`}>
                {item.type === 'question' ? (
                  <div className="bg-blue-600/30 backdrop-blur-sm rounded-xl p-4 shadow-lg border border-blue-500/30">
